...
number_of_nonprofits <- htmltools::tagList(
  ...
  htmltools::p(
    "The chart below shows financial data for the nonprofit sector overall. Select the nonprofit sizes, geographies, and date range you're interested in to create a custom chart. Use the tabs above the chart to view your selections broken out by organization type, subsector, geography, or asset size."
  ),
  ...
  htmltools::p(
    ...
    ": NCCS's ",
    htmltools::a(href = "https://urbaninstitute.github.io/nccs/datasets/bmf/", "Unified Business Master Files (BMF)"),
    ", which contains data processed from IRS BMF for calendar years 1989 through 2024. This includes all nonprofits, even those with gross receipts less than or equal to $50,000.",
...
finance_header <-
  htmltools::tagList(
    ...
    htmltools::p(
      ...
      htmltools::tags$b("Data Source"),
      ": ",
      htmltools::a(href = "https://lecy.github.io/nccs/datasets/core/", "NCCS' Core Series"),
      ", which contains data processed from the IRS' ",
      ...
      " Extracts for Form 990, 990-EZ and 990-PF for tax years 1989-2021. This panel does not include 990-N data and thus excludes small nonprofits with gross receipts less than or equal to $50,000. More information can be found in the About page. ",
      htmltools::a(href = "https://nccsdata.s3.us-east-1.amazonaws.com/dataexplorer/visuals/data_dictionary.xlsx", "Download Data Dictionary")
    )
  )
...
benefits_desc <- htmltools::p(
  "Total benefits are the sum of salaries, wages, benefits, pension plan accruals and contributions, and the 401(k) and 403(n) contributions nonprofits pay to and on behalf of employees. It provides a measure of overall spending on nonprofit-sector employees."
)

pf_header <- htmltools::tagList(
  htmltools::h4("Private Foundation Grantmaking"),
  htmltools::tagList(
    htmltools::p(
...
daf_header <- htmltools::tagList(
  htmltools::h4("Donor Advised Funds"),
  htmltools::p(
    "A ",
...
daf_proportion_desc <- htmltools::p(
  "The percentage of nonprofits that sponsor DAFs, defined as holding and operating DAF accounts, captures the prevalence of DAFs among public charities."
)
