...
customization_header <- "Customization"
customization_subheader <- "There are several ways to customize data visualizations and create panel datasets."
...
accordion_data_source <- htmltools::div(
  class = "bg-box__white",
  htmltools::div(
